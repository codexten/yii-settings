...
class Setting extends ActiveRecord
{
    ...
    {
        return [
            'id' => Yii::t('entero:process', 'ID'),
            'type' => Yii::t('entero:process', 'Type'),
            'section' => Yii::t('entero:process', 'Section'),
            'key' => Yii::t('entero:process', 'Key'),
            'value' => Yii::t('entero:process', 'Value'),
            'status' => Yii::t('entero:process', 'Status'),
            'description' => Yii::t('entero:process', 'Description'),
            'created_at' => Yii::t('entero:process', 'Created Date'),
            'updated_at' => Yii::t('entero:process', 'Updated Date'),
        ];
    }
