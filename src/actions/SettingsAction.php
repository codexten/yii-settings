...
namespace codexten\yii\settings\actions;
...
use codexten\yii\settings\events\FormEvent;

/**
 * Class SettingsAction
 *
 * @package codexten\yii\settings\actions
 */
class SettingsAction extends Action
{
    /**
     * Event is triggered before the settings will be saved.
     * Triggered with \codexten\yii\settings\events\FormEvent.
     */
