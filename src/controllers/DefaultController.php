 ...
 *
 * @package codexten\yii\settings\controllers
 */
class DefaultController extends Controller
{
     ...
     */
    public $searchClass = 'codexten\yii\settings\models\search\SettingSearch';

    /**
     * @var string model class name for CRUD operations
     */
    public $modelClass = 'codexten\yii\settings\models\SettingModel';
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', Yii::t('entero:process', 'Setting has been created.'));
    ...
    public function actionUpdate(int $id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', Yii::t('entero:process', 'Setting has been updated.'));
    ...
    public function actionDelete(int $id)
    {
        ...
        Yii::$app->session->setFlash('success', Yii::t('entero:process', 'Setting has been deleted.'));
    ...
    protected function findModel(int $id)
    {
        ...
        if (($model = $settingModelClass::findOne($id)) !== null) {
            ...
            throw new NotFoundHttpException(Yii::t('entero:process', 'The requested page does not exist.'));
        }
    }
}
